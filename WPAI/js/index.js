...
var viewProjects = function() {
    if (window.location.host === 'dev.heyleia.com') {
        window.location.href = 'https://leia.whisper.test/users/sign_in';
    } else if (window.location.host === 'test.heyleia.com') {
        window.location.href = 'https://leia.braidio.xyz/users/sign_in';
    } else if (window.location.host === 'heyleia.com' || window.location.host === 'www.heyleia.com') {
        window.location.href = 'projects';
    } else {
        window.location.href = 'https://leia.braidio.com/users/sign_in';
    }
}
...
var recordIteration = function(file) {
    //rec.exportWAV((blob) => {
        ...
        if (window.location.origin !== 'https://heyleia.com' && window.location.origin !== 'https://dev.heyleia.com') {
...
var viewPlatform = function() {
    var url = 'https://heyleia.com/editv2?domain=' + platformId;
    
    if (platformId.split('token').length === 2) {
        url = 'https://heyleia.com/provider/initiate?token=' + platformId.split('token=')[1];
    }
    ...
    //window.location.href = 'https://heyleia.com/edit?domain=' + platformId;
}
